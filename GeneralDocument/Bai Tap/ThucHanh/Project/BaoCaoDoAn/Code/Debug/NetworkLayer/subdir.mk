...
C_SRCS += \
../NetworkLayer/CanTP.c 

OBJS += \
./NetworkLayer/CanTP.o 

C_DEPS += \
./NetworkLayer/CanTP.d 


# Each subdirectory must supply rules for building sources it contributes
NetworkLayer/%.o NetworkLayer/%.su: ../NetworkLayer/%.c NetworkLayer/subdir.mk
...
clean: clean-NetworkLayer

clean-NetworkLayer:
	-$(RM) ./NetworkLayer/CanTP.d ./NetworkLayer/CanTP.o ./NetworkLayer/CanTP.su

.PHONY: clean-NetworkLayer
